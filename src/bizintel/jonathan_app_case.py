...
An example of loading and visualizing clean business data.

Author: Jonathan Stout
Date: 2027-07

Process:
    - Load clean CSV data files.
    - Visualize sales by region and product category.
    - Log a summary of findings.

Data Source:
- data/clean/customers_data.csv
- data/clean/products_data.csv
- data/clean/sales_data.csv
...
# clean data folder path (relative to the root project folder).
DATA_CLEAN: Final[Path] = Path("data/clean")

# The three clean data files for the smart sales project.
CUSTOMERS_FILE: Final[Path] = DATA_CLEAN / "clean_customers.csv"
PRODUCTS_FILE: Final[Path] = DATA_CLEAN / "clean_products.csv"
SALES_FILE: Final[Path] = DATA_CLEAN / "clean_sales.csv"
...
def main() -> None:
    ...
    log_path(LOG, "Clean data: ", DATA_CLEAN)
    ...
    plot_bar(
        ...
        x="Region",
        y="SaleAmount",
        title="Total Sales by Region Cleaned",
        xlabel="Region",
    ...
    plot_bar(
        ...
        x="Category",
        y="SaleAmount",
        title="Total Sales by Product Category Cleaned",
        xlabel="Category",
        ylabel="Total Sales Amount ($)",
        palette="Purples_d",
    )
    ...
    LOG.info("========================")
    LOG.info("Jonathans custom app Executed successfully!")
    LOG.info("========================")
